...
namespace Schedule
{
    public partial class FormMain : Form
    {
        ...
        private void butEditTeacher_Click(object sender, EventArgs e) //кнопка изменения во вкладке преподаватель
        {
        ...
        private void butDelTeacher_Click(object sender, EventArgs e) //кнопка удаления во вкладке преподаватель
        {
            Teacher obj = getObj<Teacher>(dgvTeachers, null);
            if (obj == null)
            {
        ...
        private void butEditGroup_Click(object sender, EventArgs e) //кнопка изменения во вкладке группы
        {
        ...
        private void butDelGroup_Click(object sender, EventArgs e) //кнопка удаления во вкладке группы
        {
            Group obj = getObj<Group>(dgvGroups, null);
            if (obj == null)
            {
            ...
            string str = "";
            if (!FormInput.InputQuery("Введите 1 для удаления записи", ref str)) return; //подтверждение удаления
        ...
        private void butDelElem_Click(object sender, EventArgs e)
        {
